...
export const ISPForm: React.FC<ISPFormProps> = ({ formData, handleInputChange, isEditing }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      ══════════════════════════════════════════ */}
      <div>
        <SectionHeader icon={Building2} label="ISP Details" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="name" className={labelClass}>
              ISP Name <span className="text-rose-500 ml-0.5">*</span>
            </label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="contact_person" className={labelClass}>
              Contact Person <span className="text-rose-500 ml-0.5">*</span>
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="space-y-1.5">
            <label htmlFor="phone" className={labelClass}>
              Phone <span className="text-rose-500 ml-0.5">*</span>
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
