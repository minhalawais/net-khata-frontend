...
import { EmployeeFilterState } from '../types';

interface EmployeeStore {
    filters: EmployeeFilterState;
    setFilters: (filters: Partial<EmployeeFilterState>) => void;
...
export const useEmployeeAnalyticsStore = create<EmployeeStore>((set) => ({
